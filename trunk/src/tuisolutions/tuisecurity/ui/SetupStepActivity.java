...
public class SetupStepActivity extends Activity {
	...
	private void commit() {
		...
		editor.putString(Parameters.SETTINGS_NUMBER_RETURN, m_txtMobile
				.getText().toString());
		editor.putString(Parameters.SETTINGS_MSG_RETURN, m_txtMsgReturn
				.getText().toString());
		...
		// Save SIM serials
		SIM m_sim = new SIMController(getApplicationContext()).getSIMInfo();
		editor.putString(Parameters.OLD_SIM_SERIAL, m_sim.getSerial().toString());
		// Call service to link this SIM serial with this username
		// TODO
	...
	private String checkCondition(int isStep) {
		...
		if (isStep == 1) {
			if (!m_txtNewPin_1.getText().equals(null)
					&& !m_txtNewPin_2.getText().equals(null)
					&& !m_txtNewPin_3.getText().equals(null)
					&& !m_txtNewPin_4.getText().equals(null)
					&& !m_txtPinAgain_1.getText().equals(null)
					&& !m_txtPinAgain_2.getText().equals(null)
					&& !m_txtPinAgain_3.getText().equals(null)
					&& !m_txtPinAgain_4.getText().equals(null)) {
				...
				String newPinAgain_1 = m_txtPinAgain_1.getText().toString()
						.trim();
				String newPinAgain_2 = m_txtPinAgain_2.getText().toString()
						.trim();
				String newPinAgain_3 = m_txtPinAgain_3.getText().toString()
						.trim();
				String newPinAgain_4 = m_txtPinAgain_4.getText().toString()
						.trim();

				if (!newPin_1.equals("") && !newPin_2.equals("")
						&& !newPin_3.equals("") && !newPin_4.equals("")) {
					newPin = newPin_1.concat(newPin_2).concat(newPin_3)
							.concat(newPin_4);
				} else {
				...
				if (!newPinAgain_1.equals("") && !newPinAgain_2.equals("")
						&& !newPinAgain_3.equals("")
						&& !newPinAgain_4.equals("")) {
					newPinAgain = newPinAgain_1.concat(newPinAgain_2)
							.concat(newPinAgain_3).concat(newPinAgain_4);
				} else {
