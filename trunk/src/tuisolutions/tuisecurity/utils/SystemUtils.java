...
//	}
	...
	{				
    	...
    	{
			Log.e(SystemUtils.class.getName(), "Ошибка создания папки: " + folder.getAbsolutePath());
			throw new IOException("Ошибка создания папки: " + path);    		
    	}
		...
		if (used > 85)
		{
			Log.e(SystemUtils.class.getName(), "Осталось мало места на диске");
			throw new IOException("Осталось мало места на диске");
		}   	
    	
    	File file = new File(path, fileName);
		if (!file.exists() && !file.createNewFile())
		{
			Log.e(SystemUtils.class.getName(), "Ошибка создания файла: " + file.getAbsolutePath());
			throw new IOException("Ошибка создания файла: " + file.getAbsolutePath());
		}    				
		return file;
	}
}
