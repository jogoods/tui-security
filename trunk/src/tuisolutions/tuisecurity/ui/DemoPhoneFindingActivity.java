...
public class DemoPhoneFindingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_demo_phone_locate);
		...
		m_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				editor.putBoolean(Parameters.SERVICE_PHONE_FINDING, isChecked);
				editor.commit();
			}
		});
	}
